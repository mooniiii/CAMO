			...
			<div class="read">
                <h2><a href="/board/cm_news/list">NEWS</a></h2>
              	<div class="readIn">
                    ...
                    <div class="readBtn">
                        <button class="readModifyBtn"><a href="/board/cm_news/modify?bno=${read.bno}">수정하기</a></button>
						<button class="readDeleteBtn"><a href="/board/cm_news/remove?bno=${read.bno}">삭제하기</a></button>
                    </div>
                </div> <!-- .readIn -->
            </div> <!-- .read-->
